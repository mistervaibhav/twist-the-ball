...
namespace AppAdvisory.TwistTheBall
{
	...
	public class Welcome : EditorWindow 
	{
		...
		/******* TO MODIFY **********/
		/******* TO MODIFY **********/
		private const string ONLINE_DOC_URL = "https://docs.google.com/document/d/16fqn6BouzhvmN-lUeLgS04vYtncCuwfzmzUCTkfECd0/edit?usp=sharing";
		private const string RATEUS_URL = "http://u3d.as/mqL";

		private const string NAME_OF_THE_GAME = "TWIST THE BALL - PLATFORM JUMPER";
		/******* TO MODIFY **********/
		/******* TO MODIFY **********/
		/******* TO MODIFY **********/
		/******* TO MODIFY **********/
